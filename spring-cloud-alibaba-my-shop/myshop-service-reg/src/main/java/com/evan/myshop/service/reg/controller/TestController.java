...
public class TestController {
    ...
    public AbstractBaseResult getById(HttpServletRequest request, @PathVariable long id) {
        ...
        if (id == 1) {
            ...
            return BaseResultFactory.build(HttpStatus.UNAUTHORIZED.value(), "参数类型错误", "ID 只能为 1", applicationContext.getEnvironment().getProperty("logging.level.com.evan.myshop"));
        }
    }
