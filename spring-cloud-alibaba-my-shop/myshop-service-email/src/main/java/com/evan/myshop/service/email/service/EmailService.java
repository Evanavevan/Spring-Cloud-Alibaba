package com.evan.myshop.service.email.service;
...
public class EmailService {
    ...
    public void sendEmail(String subject, String body, String to) {
        ...
        message.setFrom(Objects.requireNonNull(applicationContext.getEnvironment().getProperty("spring.mail.username")));
        message.setTo(to);
